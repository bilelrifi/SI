                    ...
                    withCredentials([
                        ...
                        sh '''
                            ...
                            if [ -f "./frontend/Containerfile" ]; then
                                ...
                                sed 's|FROM nginx:alpine|FROM quay.io/jitesoft/nginx:alpine|g; s|FROM node:|FROM quay.io/ubi8/nodejs-20:|g' ./frontend/Containerfile > ./frontend/Containerfile.fixed
                    ...
                    withCredentials([
                        ...
                        sh '''
                            ...
                            if [ -f "./backend/Containerfile" ]; then
                                ...
                                # Create a temporary fixed Containerfile
                                echo "Creating fixed Containerfile with fully qualified image names..."
                                sed 's|FROM node:|FROM quay.io/ubi8/nodejs-20:|g; s|FROM alpine|FROM quay.io/ubi8/ubi-minimal|g' ./backend/Containerfile > ./backend/Containerfile.fixed
